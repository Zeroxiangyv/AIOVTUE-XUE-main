...
import type { GalleryHubFrontmatter } from '~/types/album'
import { useAlbumSummaries } from '../../utils/useAlbumSummaries'
import AlbumTimeline from '../AlbumTimeline.vue'

const frontmatter = useFrontmatter<GalleryHubFrontmatter>()
...
const albums = useAlbumSummaries(() => frontmatter.value?.albums)
</script>
